  ...
  return merge(baseConfig as any, {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        ...
        template: (siteConfig.desktop && siteConfig.desktop.template) || join(__dirname, '../../site/desktop/index.html'),
        filename: 'index.html',
        baiduAnalytics,
      }),
      new HtmlWebpackPlugin({
        ...
        template: (siteConfig.mobile && siteConfig.mobile.template) || join(__dirname, '../../site/mobile/index.html'),
